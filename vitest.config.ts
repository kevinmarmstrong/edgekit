...
export default defineConfig({
  resolve: {
    alias: [
      ...
      { find: /^@kevinmarmstrong\/edgekit\/lite$/, replacement: fileURLToPath(new URL('./packages/core/src/lite.ts', import.meta.url)) },
      ...
      { find: /^@kevinmarmstrong\/edgekit-ui\/lite$/, replacement: fileURLToPath(new URL('./packages/ui/src/lite.ts', import.meta.url)) },
